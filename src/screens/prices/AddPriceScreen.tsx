      ...
      <View style={styles.content}>
        <View style={styles.iconArea}>
          <View style={styles.iconCircle}>
            <Ionicons name="add-circle-outline" size={36} color={Colors.orange} />
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  iconCircle: {
    ...
    backgroundColor: Colors.orange + '22', alignItems: 'center', justifyContent: 'center',
  ...
  previewAmount: { fontSize: 24, fontWeight: '800', color: Colors.orange },
